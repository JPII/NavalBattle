...
public class GameComponent extends JComponent {
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("In the future, this is where the map, enitities, and GUI would go.", 100, 120);
		g.drawString("Just to make sure that the ticker/updater is working, here is how many ticks performed:" + test, 100, 140);
	}
