...
public class NavalGame extends Game {
	...
	public void mouseDown(MouseEvent me) {
		...
		if (me.getButton() == MouseEvent.BUTTON1)
			new BattleShip(this.getWorld().getEntityManager(),new Location(chy,chx),BattleShip.BATTLESHIP_ID,1);
		else if (Game.Settings.isFinishedGenerating && getWorld().getEntityManager().getTilePercentLand(chy,chx) <= 5)
			new Whale(this.getWorld().getEntityManager(),new Location(chy,chx),0,NavalManager.w1,NavalManager.w2,NavalManager.w3);
